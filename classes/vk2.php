...
class Vk{
    ...
    private $v = '5.35'; // верси€ Api VKontakte @link https://vk.com/dev/versions
    const VERSION = '2.0'; // верси€ этой библиотеки
    ...
    /**
     * Ёто  онструктор ( эп.)
     * ѕередаютс€ параметры настроек
     * @param array $options
     */
    function __construct( $options = [] ){

        $this->scope[]='offline'; // об€зательно запрашиваем права на оффлайн работу без участи€ пользовател€
    ...
    /**
     * ѕостроение конечного URI дл€ выхова
     * @param $method
     * @param string $params
     * @return string
     */
    ...
    /**
     * ѕолучить ссылка на запрос прав доступа
     *
    ...
    private function call($url = ''){
        ...
        // ѕроизошла ошибка на стороне VK, коды ошибок тут https://vk.com/dev/errors
    ...
    */
     ...
     * @param bool $gid
     * @param array $files
     * @param bool (TRUE = вернуть список id файлов | FALSE = вернуть массив аттачей дл€ прикреплени€)
     * @return array|bool
     */
    ...
    /**
     * «аливка документа (например GIF файл)
     *
     * @param bool $gid
     * @param $file
     * @return bool|string
    ...
    public function upload_video($options = [], $file = false){
        ...
        if($file && file_exists($file)){
            ...
            // иначе просто обращаемс€ по адресу (ну надо так!)
        } else {
    ...
    /**
     * «агружает видео из массива ссылок
     *
     * @param array $videos Ч массив ссылок на видео (youtube/vimeo)
     * @return array Ч массив загруженных видео (прикреплений) дл€ использовани€ при постинге
     */
